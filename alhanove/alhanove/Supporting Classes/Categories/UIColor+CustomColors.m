...
{
    return [UIColor colorWithHexString:@"#FF7700"];
}

+ (UIColor *) dialogDefaultBackgroundColor {
    return [UIColor colorWithHexString:@"#dddddd"];
}

+ (UIColor *) dialogDefaultForegroundColor {
    return [UIColor colorWithHexString:@"#ff000000"];
}

+ (UIColor *) dialogOkBackgroundColor {
    return [UIColor colorWithHexString:@"#dd81dc81"];
}

+ (UIColor *) dialogOkForegroundColor {
    return [UIColor colorWithHexString:@"#ff000000"];
}

+ (UIColor *) dialogErrorBackgroundColor {
    return [UIColor colorWithHexString:@"#dddb887d"];
}

+ (UIColor *) dialogErrorForegroundColor {
    return [UIColor colorWithHexString:@"#ffffffff"];
}

+ (UIColor *) dialogConfirmBackgroundColor {
    return [UIColor colorWithHexString:@"#ddc6a242"];
}

+ (UIColor *) dialogConfirmForegroundColor {
    return [UIColor colorWithHexString:@"#ff000000"];
}

+ (UIColor *) dialogWarningBackgroundColor {
    return [UIColor colorWithHexString:@"#dddb887d"];
}

+ (UIColor *) dialogWarningForegroundColor {
    return [UIColor colorWithHexString:@"#ffffffff"];
}
