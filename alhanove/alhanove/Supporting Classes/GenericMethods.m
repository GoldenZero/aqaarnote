...
+ (BOOL) cacheBannerAppearsForMarketFromCounter:(NSNumber *) NumberOfAppear {
    
    //1- get the file name same as request url
    NSString * cacheFileName = [self getCacheFileNameForBannerAppearsForMarket];
...
+ (NSString *) getCacheFileNameForBannerAppearsForMarket
{
...
+ (NSNumber *) getCachedBannerAppearsForMarket {
...
+ (BOOL) cacheBannerAppearsForArticleFromCounter:(NSNumber *) NumberOfAppear {
    
    //1- get the file name same as request url
    NSString * cacheFileName = [self getCacheFileNameForBannerAppearsForArticle];
    ...
    //3- create the dictionary to be serialized to JSON
    NSMutableDictionary * dictToBeWritten = [NSMutableDictionary new];
    [dictToBeWritten setObject:NumberOfAppear forKey:@"BannerAppearsForArticle"];
...
+ (NSString *) getCacheFileNameForBannerAppearsForArticle
{
    
    //the file name is the string of listing URL without the page number and page size
    NSString * fullURLString = @"/CurrentAppearsForArticle";
...
+ (NSNumber *) getCachedBannerAppearsForArticle {
    ...
    NSNumber * resultNum = [dataDict objectForKey:@"BannerAppearsForArticle"];
    return resultNum;
}
